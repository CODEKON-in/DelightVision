...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-ivory">
      <a
        href="#services"
        className="sr-only focus:not-sr-only focus:absolute focus:top-3 focus:left-3 focus:z-50 focus:rounded-full focus:bg-charcoal focus:px-5 focus:py-3 focus:font-semibold focus:text-ivory-light"
      >
        {ui.skipToServices}
      </a>
